...
def load_v2_models(args: argparse.Namespace) -> Any:
    ...
    Args:
        args: Command line arguments containing:
            - ar_checkpoint_path: Optional path to AR checkpoint
            - cfm_checkpoint_path: Optional path to CFM checkpoint
            - compile: Whether to compile models for faster inference
...
def convert_voice_v2(
    ...
    Args:
        ...
        args: Command line arguments containing conversion parameters:
            - diffusion_steps: Number of diffusion steps
            - length_adjust: Speech speed adjustment factor
            - intelligibility_cfg_rate: Intelligibility configuration rate
            - similarity_cfg_rate: Similarity configuration rate
    ...
    Returns:
        Tuple of (sample_rate, audio_array) or None if conversion fails.
    """
...
def main(args: argparse.Namespace) -> None:
    """Main function to run voice conversion inference.
    ...
    filename = (
        ...
        f"{args.length_adjust}_{args.diffusion_steps}_{args.similarity_cfg_rate}.wav"
    )
