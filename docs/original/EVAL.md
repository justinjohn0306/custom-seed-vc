...
Source audios can be found under `./assets/examples/libritts-test-clean` <br>
Reference audios can be found under `./assets/examples/reference` <br>
...
```bash
python eval.py
--source ./assets/examples/libritts-test-clean
--target ./assets/examples/reference
--output ./assets/examples/eval/converted
--diffusion-steps 25
--length-adjust 1.0
